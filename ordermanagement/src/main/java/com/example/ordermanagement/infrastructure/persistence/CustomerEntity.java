...
public class CustomerEntity {
    ...
    // ADD THIS LINE - Hibernate is looking for this for the Foreign Key!
    ...
    public CustomerEntity(String authUserId, String authId, String fullName, String email, String phone) {
